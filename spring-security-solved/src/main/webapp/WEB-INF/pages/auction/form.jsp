...
<body>
	...
	<spring:url value="/auctions/save" var="auctionSaveUrl" />
	<div class="container">
		<c:choose>
		...
		<form:form class="form-horizontal" method="post"
			...
			<form:hidden path="creatorUserName" />
			...
			<spring:bind path="expiryDate">
				<div class="form-group ${status.error ? 'has-error' : ''}">
					...
					<div class="col-sm-10">
						<form:input path="expiryDate" type="datetime"
							class="form-control " id="auctionType"
